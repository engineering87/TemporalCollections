...
{
    [MemoryDiagnoser]
    public class TemporalStackBenchmarks
    {
        private TemporalStack<int> _stack;
        private List<int> _testData;

        [GlobalSetup]
        public void Setup()
        {
            _stack = new TemporalStack<int>();
        ...
        public void QueryRange()
        {
            ...
            var results = _stack.GetInRange(from, to);
        }
